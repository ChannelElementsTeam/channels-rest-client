...
export const SWITCH_PROTOCOL_VERSION = 1;
export const BANK_PROTOCOL_VERSION = 1;
export const CARD_REGISTRY_PROTOCOL_VERSION = 1;
export const MINE_PROTOCOL_VERSION = 1;
...
export class ChannelsRestClient {
  ...
  async registerBankUser(serviceUrl: string, signedKeyIdentity: SignedKeyIdentity): Promise<BankRegisterUserResponse> {
    return await this.requestService<SignedKeyIdentity, BankRegisterUserDetails, BankRegisterUserResponse>(signedKeyIdentity, serviceUrl, BANK_PROTOCOL_VERSION, 'register-user', {});
  }
  ...
  async registerSwitchUser(serviceUrl: string, signedKeyIdentity: SignedKeyIdentity, details?: SwitchRegisterUserDetails): Promise<SwitchRegisterUserResponse> {
    return await this.requestService<SignedKeyIdentity, SwitchRegisterUserDetails, SwitchRegisterUserResponse>(signedKeyIdentity, serviceUrl, SWITCH_PROTOCOL_VERSION, 'register-user', details ? details : {});
  }
  ...
  async registerCardRegistryUser(serviceUrl: string, signedKeyIdentity: SignedKeyIdentity): Promise<CardRegistryRegisterUserResponse> {
    return await this.requestService<SignedKeyIdentity, CardRegistryRegisterUserDetails, CardRegistryRegisterUserResponse>(signedKeyIdentity, serviceUrl, CARD_REGISTRY_PROTOCOL_VERSION, 'register-user', {});
  }

  async registerMineUser(serviceUrl: string, signedKeyIdentity: SignedKeyIdentity): Promise<MineRegisterUserResponse> {
    return await this.requestService<SignedKeyIdentity, MineRegisterUserDetails, MineRegisterUserResponse>(signedKeyIdentity, serviceUrl, MINE_PROTOCOL_VERSION, 'register-user', {});
  }
  ...
  async registerBankBank(serviceUrl: string, signedKeyIdentity: SignedKeyIdentity, details: BankRegisterBankDetails): Promise<BankRegisterBankResponse> {
    return await this.requestService<SignedKeyIdentity, BankRegisterBankDetails, BankRegisterBankResponse>(signedKeyIdentity, serviceUrl, BANK_PROTOCOL_VERSION, 'register-bank', details);
  }
  async registerBankMine(serviceUrl: string, signedKeyIdentity: SignedKeyIdentity, details: BankRegisterMineDetails): Promise<BankRegisterMineResponse> {
    return await this.requestService<SignedKeyIdentity, BankRegisterMineDetails, BankRegisterMineResponse>(signedKeyIdentity, serviceUrl, BANK_PROTOCOL_VERSION, 'register-mine', details);
  }

  async bankGetAccount(serviceUrl: string, identity: SignedAddressIdentity): Promise<BankGetAccountResponse> {
    return await this.requestService<SignedAddressIdentity, BankGetAccountDetails, BankGetAccountResponse>(identity, serviceUrl, BANK_PROTOCOL_VERSION, 'get-account', {});
  }
  ...
  async bankTransfer(serviceUrl: string, identity: SignedAddressIdentity, details: BankTransferDetails): Promise<BankTransferResponse> {
    return await this.requestService<SignedAddressIdentity, BankTransferDetails, BankTransferResponse>(identity, serviceUrl, BANK_PROTOCOL_VERSION, 'transfer', details);
  }
  ...
  async interBankTransfer(serviceUrl: string, identity: SignedAddressIdentity, details: InterBankTransferDetails): Promise<InterBankTransferResponse> {
    return await this.requestService<SignedAddressIdentity, InterBankTransferDetails, InterBankTransferResponse>(identity, serviceUrl, BANK_PROTOCOL_VERSION, 'interbank-transfer', details);
  }
  ...
  async switchPay(serviceUrl: string, identity: SignedAddressIdentity, details: SwitchPaymentDetails): Promise<SwitchPaymentResponse> {
    return await this.requestService<SignedAddressIdentity, SwitchPaymentDetails, SwitchPaymentResponse>(identity, serviceUrl, SWITCH_PROTOCOL_VERSION, 'pay', details);
  }
  ...
  async switchCreateChannel(serviceUrl: string, identity: SignedAddressIdentity, details: ChannelCreateDetails): Promise<ChannelCreateResponse> {
    return await this.requestService<SignedAddressIdentity, ChannelCreateDetails, ChannelCreateResponse>(identity, serviceUrl, SWITCH_PROTOCOL_VERSION, 'create', details);
  }
  ...
  async switchShareChannel(serviceUrl: string, identity: SignedAddressIdentity, details: ChannelShareDetails): Promise<ChannelShareResponse> {
    return await this.requestService<SignedAddressIdentity, ChannelShareDetails, ChannelShareResponse>(identity, serviceUrl, SWITCH_PROTOCOL_VERSION, 'share', details);
  }
  ...
  async switchGetChannel(serviceUrl: string, identity: SignedAddressIdentity, details: ChannelGetDetails): Promise<ChannelGetResponse> {
    return await this.requestService<SignedAddressIdentity, ChannelGetDetails, ChannelGetResponse>(identity, serviceUrl, SWITCH_PROTOCOL_VERSION, 'get', details);
  }
  ...
  async switchAcceptChannel(serviceUrl: string, identity: SignedAddressIdentity, details: ChannelAcceptDetails): Promise<ChannelAcceptResponse> {
    return await this.requestService<SignedAddressIdentity, ChannelAcceptDetails, ChannelAcceptResponse>(identity, serviceUrl, SWITCH_PROTOCOL_VERSION, 'accept', details);
  }
  ...
  async switchDeleteChannel(serviceUrl: string, identity: SignedAddressIdentity, details: ChannelDeleteDetails): Promise<ChannelDeleteResponse> {
    return await this.requestService<SignedAddressIdentity, ChannelDeleteDetails, ChannelDeleteResponse>(identity, serviceUrl, SWITCH_PROTOCOL_VERSION, 'delete', details);
  }
  ...
  async switchListChannels(serviceUrl: string, identity: SignedAddressIdentity, details: ChannelsListDetails): Promise<ChannelsListResponse> {
    return await this.requestService<SignedAddressIdentity, ChannelsListDetails, ChannelsListResponse>(identity, serviceUrl, SWITCH_PROTOCOL_VERSION, 'list', details);
  }
  ...
  async switchGetRegistration(serviceUrl: string, identity: SignedAddressIdentity, details: GetSwitchRegistrationDetails): Promise<GetSwitchRegistrationResponse> {
    return await this.requestService<SignedAddressIdentity, GetSwitchRegistrationDetails, GetSwitchRegistrationResponse>(identity, serviceUrl, SWITCH_PROTOCOL_VERSION, 'get-registration', details);
  }
  ...
  async switchUpdateRegistration(serviceUrl: string, identity: SignedAddressIdentity, details: UpdateSwitchRegistrationDetails): Promise<UpdateSwitchRegistrationResponse> {
    return await this.requestService<SignedAddressIdentity, UpdateSwitchRegistrationDetails, UpdateSwitchRegistrationResponse>(identity, serviceUrl, SWITCH_PROTOCOL_VERSION, 'update-registration', details);
  }
  ...
  async cardRegistryPay(serviceUrl: string, identity: SignedAddressIdentity, details: CardRegistryPaymentDetails): Promise<CardRegistryPaymentResponse> {
    return await this.requestService<SignedAddressIdentity, CardRegistryPaymentDetails, CardRegistryPaymentResponse>(identity, serviceUrl, CARD_REGISTRY_PROTOCOL_VERSION, 'pay', details);
  }
  ...
  async cardRegistrySearch(serviceUrl: string, identity: SignedAddressIdentity, details: CardRegistrySearchDetails): Promise<CardRegistrySearchResponse> {
    return await this.requestService<SignedAddressIdentity, CardRegistrySearchDetails, CardRegistrySearchResponse>(identity, serviceUrl, CARD_REGISTRY_PROTOCOL_VERSION, 'search', details);
  }
  ...
  async cardRegistryGetReviews(serviceUrl: string, identity: SignedAddressIdentity, details: CardRegistryGetReviewsDetails): Promise<CardRegistryGetReviewsResponse> {
    return await this.requestService<SignedAddressIdentity, CardRegistryGetReviewsDetails, CardRegistryGetReviewsResponse>(identity, serviceUrl, CARD_REGISTRY_PROTOCOL_VERSION, 'get-reviews', details);
  }
  ...
  async cardRegistryReview(serviceUrl: string, identity: SignedAddressIdentity, details: CardRegistryReviewDetails): Promise<CardRegistryReviewResponse> {
    return await this.requestService<SignedAddressIdentity, CardRegistryReviewDetails, CardRegistryReviewResponse>(identity, serviceUrl, CARD_REGISTRY_PROTOCOL_VERSION, 'review', details);
  }
  ...
  async cardRegistryNotifyPurchase(serviceUrl: string, identity: SignedAddressIdentity, details: CardRegistryNotifyPurchaseDetails): Promise<CardRegistryNotifyPurchaseResponse> {
    return await this.requestService<SignedAddressIdentity, CardRegistryNotifyPurchaseDetails, CardRegistryNotifyPurchaseResponse>(identity, serviceUrl, CARD_REGISTRY_PROTOCOL_VERSION, 'notify-purchase', details);
  }

  async minePoll(serviceUrl: string, identity: SignedAddressIdentity, details: MinePollDetails): Promise<MinePollResponse> {
    return await this.requestService<SignedAddressIdentity, MinePollDetails, MinePollResponse>(identity, serviceUrl, MINE_PROTOCOL_VERSION, 'poll', details);
  }
